...
levels(as.factor(test_data_copy$engine_transmission_engine_sound_cc_value_0))
...
levels(as.factor(test_data_copy$engine_transmission_exhaust_smoke_cc_value_0))
